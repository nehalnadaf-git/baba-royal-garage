          ...
          {cards.map((card, index) => {
            const image = (
              <div className="relative w-full h-full overflow-hidden rounded-[14px]">
                ...
                {/* Shimmer on hover */}
                <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-in-out skew-x-12 mix-blend-overlay z-30 pointer-events-none" />
              </div>
            );
            ...
            return card.linkUrl ? (
              <a
                ...
                style={{
                  boxShadow: "0 12px 40px rgba(0,0,0,0.28), 0 3px 10px rgba(0,0,0,0.16)",
                  borderRadius: 14,
                  overflow: "hidden",
                }}
              >
